...
/* harmony import */ var _model_movie_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../model/movie.js */ "./src/model/movie.js");
...
class Api {
  ...
  getFilms() {
    ...
    .then(Api.toJSON)
    .then((films) => films.map(_model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient))
...
.then(Api.toJSON)
.then((comments) => _model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].combineDataToClient(comments, film));
  }
  ...
  updateFilm(film) {
    return this._load({
      url: `movies/${film.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(film)),
      headers: new Headers({"Content-Type": `application/json`})
    })
    .then(Api.toJSON)
    .then(_model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient)
.then((response) => this._getComments(response));
  ...
  addComment(film, comment) {
    ...
    .then(Api.toJSON)
    .then((response) => {
      const adaptedFilm = _model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient(response.movie);
      return _model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].combineDataToClient(response.comments, adaptedFilm);
    });
  }
...
const createStoreCommentsStructure = (items) => {
  return items.reduce((acc, current) => {
    return Object.assign({}, acc, {
      [current.id]: _model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptCommentsToServer(current),
    });
  }, {});
};
  ...
  getFilms() {
    if (Provider.isOnline()) {
      return this._api.getFilms()
        .then((films) => {
          const adaptedFilms = createStoreStructure(films.map(_model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer));
    ...
    const storeFilms = Object.values(this._store.getItems().films).map(_model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
    const storeComments = Object.values(this._store.getItems().comments);
    return Promise.resolve(storeFilms.map((film) => _model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].combineDataToClient(storeComments[film.id], film)));
  }
  ...
  updateFilm(film) {
    if (Provider.isOnline()) {
      return this._api.updateFilm(film)
        .then((updatedFilm) => {
          this._store.setFilm(updatedFilm.id, _model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(updatedFilm));
          return updatedFilm;
        });
    }

    this._store.setFilm(film.id, _model_movie_js__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(Object.assign({}, film)));
...
/* harmony import */ var _templates_footer_stats_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./templates/footer-stats.js */ "./src/templates/footer-stats.js");
...
/* harmony import */ var _model_menu_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./model/menu.js */ "./src/model/menu.js");
/* harmony import */ var _model_movie_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/movie.js */ "./src/model/movie.js");
/* harmony import */ var _model_filter__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/filter */ "./src/model/filter.js");
/* harmony import */ var _templates_statistics_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./templates/statistics.js */ "./src/templates/statistics.js");
/* harmony import */ var _templates_status_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./templates/status.js */ "./src/templates/status.js");
...
const api = new _api_index_js__WEBPACK_IMPORTED_MODULE_10__["default"](END_POINT, AUTHORIZATION);
...
const filmsModel = new _model_movie_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
const filterModel = new _model_filter__WEBPACK_IMPORTED_MODULE_5__["default"]();
const menuModel = new _model_menu_js__WEBPACK_IMPORTED_MODULE_3__["default"]();

const userRank = new _templates_status_js__WEBPACK_IMPORTED_MODULE_7__["default"](filmsModel);
const footerStats = new _templates_footer_stats_js__WEBPACK_IMPORTED_MODULE_1__["default"](filmsModel);
const movieList = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_8__["default"](filterModel, filmsModel, apiWithProvider);
const filterPresenter = new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_2__["default"](siteMainElement, filterModel, menuModel, filmsModel);
...
const handleSiteMenuClick = (menuItem) => {
  ...
  switch (menuItem) {
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].FILTER:
      menuModel.setMenuItem(menuItem, _utils_const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].FILTER);
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["remove"])(statisticsComponent);
      movieList.init();
      break;
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATISTICS:
      menuModel.setMenuItem(menuItem, _utils_const_js__WEBPACK_IMPORTED_MODULE_9__["MenuItem"].STATISTICS);
      movieList.destroy();
      statisticsComponent = new _templates_statistics_js__WEBPACK_IMPORTED_MODULE_6__["default"](filmsModel.getFilms());
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(siteMainElement, statisticsComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
      statisticsComponent.init();
      break;
  }

  menuModel.setMenuItem(_utils_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].NONE, menuItem);
};

movieList.init();
filterPresenter.init();

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(siteHeaderElement, userRank.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(footerStatisticsElements, footerStats, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);

apiWithProvider.getFilms()
.then((films) => {
  filterPresenter.setInnerHandlers();
  filterPresenter.setMenuClickHandler(handleSiteMenuClick);
  filmsModel.setFilms(_utils_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, films);
})
 .catch(() => {
   filterPresenter.setInnerHandlers();
   filterPresenter.setMenuClickHandler(handleSiteMenuClick);
   filmsModel.setFilms(_utils_const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT, []);
 });
...
class Menu extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    ...
    this._activeMenuItem = _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER;
  }
...
class Film {
  ...
  init(film) {
    ...
    this._filmPopUpComponent = new _templates_pop_up_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._film, this._api);
    ...
    if (prevFilmComponent === null || prevFilmPopUpComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["renderElement"])(this._container, this._filmComponent.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
      return;
    }

    if (this._container.contains(prevFilmComponent.getElement())) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["renderElement"])(document.body, prevFilmPopUpComponent);
    }
    ...
    if (this._mode === Mode.DETAILS) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["replace"])(this._filmPopUpComponent, prevFilmPopUpComponent);
    }

    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevFilmComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(prevFilmPopUpComponent);
  }

  destroy() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._filmComponent);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["remove"])(this._filmPopUpComponent);
  }
  resetView() {
  ...
  _handlePopUpRemoveClick(film) {
    this._changeData(
        _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].UPDATE_MOVIE,
        _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MINOR,
        film
    );
    this._hidePopUp();
  }
  ...
  _handleAddCommentKeyDown(film) {
    this._changeData(
        _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].ADD_COMMENT,
        _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH,
        film
    );
  }
  ...
  _handleDeleteClick(film) {
    this._changeData(
        _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UserAction"].DELETE_COMMENT,
        _utils_const_js__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].PATCH,
        film
    );
  }
  ...
  _showPopUp() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["renderElement"])(document.body, this._filmPopUpComponent.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return Filter; });
/* harmony import */ var _templates_menu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../templates/menu.js */ "./src/templates/menu.js");
...
class Filter {
  ...
  init() {
    ...
    this._filterComponent = new _templates_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentFilter, this._currentMenuItem);

    if (prevFilterComponent === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["renderElement"])(this._filterContainer, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
      return;
    }
...
/* harmony import */ var _templates_loading_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../templates/loading.js */ "./src/templates/loading.js");
/* harmony import */ var _templates_no_data_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../templates/no-data.js */ "./src/templates/no-data.js");
...
class MovieList {
  constructor(filterModel, filmsModel, api) {
    ...
    this._currentSortType = _utils_sort__WEBPACK_IMPORTED_MODULE_7__["SortType"].DEFAULT;
    this._handleSortTypeChange = this._handleSortTypeChange.bind(this);
    this._handleModeChange = this._handleModeChange.bind(this);
    this._handleShowMoreButtonClick = this._handleShowMoreButtonClick.bind(this);
    this._handleViewAction = this._handleViewAction.bind(this);
    this._handleModelEvent = this._handleModelEvent.bind(this);
    this._loadingComponent = new _templates_loading_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._noDataComponent = new _templates_no_data_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
  }
  ...
  _getFilms() {
    ...
    const films = this._filmsModel.getFilms();
    const filteredFilms = _utils_filter__WEBPACK_IMPORTED_MODULE_5__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _utils_sort__WEBPACK_IMPORTED_MODULE_7__["SortType"].DATE:
        return filteredFilms.slice().sort(_utils_sort__WEBPACK_IMPORTED_MODULE_7__["sortByDate"]);
      case _utils_sort__WEBPACK_IMPORTED_MODULE_7__["SortType"].RATING:
        return filteredFilms.slice().sort(_utils_sort__WEBPACK_IMPORTED_MODULE_7__["sortByRating"]);
      default:
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_8__["UserAction"].UPDATE_MOVIE:
        this._api.updateFilm(update)
       .then((response) => this._filmsModel.updateFilm(updateType, response));
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_8__["UserAction"].ADD_COMMENT:
        this._filmsModel.addComment(updateType, update);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_8__["UserAction"].DELETE_COMMENT:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].PATCH:
        this._handleFilmsChange(data);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].MINOR:
        this._clearFilmsList();
        this._renderContainer();
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].MAJOR:
        this._clearFilmsList({resetRenderedFilmsCount: true, resetSortType: true});
        this._renderContainer();
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].INIT:
  ...
  _renderSort() {
    ...
    this._sortComponent = new _templates_sort_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentSortType);
    if (!this._isLoading) {
      this._sortComponent.setSortTypeChangeHandler(this._handleSortTypeChange);
    }
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(filmsListContainer, this._sortComponent.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }

  _renderFilmCard(container, film) {
    const Movie = new _film_js__WEBPACK_IMPORTED_MODULE_1__["default"](container, this._handleViewAction, this._handleModeChange, this._api);
    Movie.init(film);
  ...
  _renderNoData() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(siteMainElement, this._noDataComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }

  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(siteMainElement, this._loadingComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }
  ...
  _renderShowMoreBtn() {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["renderElement"])(siteMainElement, this._showMoreBtnComponent.getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  }
  ...
  _clearFilmsList({resetRenderedFilmsCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._showMoreBtnComponent);
...
const createFilmCardTemplate = (film) => {
  ...
  const formattedRuntime = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["getFormattedRuntime"])(filmDuration);
...
/* harmony import */ var _abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract */ "./src/templates/abstract.js");
...
const createFilterItemTemplate = (filter, currentFilterType) => {
  ...
  return (
    `<a href="#${type}" data-filter-type="${type}" data-menu-item="${_utils_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER}" class="main-navigation__item ${type === currentFilterType ? `main-navigation__item--active` : ``}">
      ${type === _utils_const__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL ? name : createFilterItemCountTemplate()}
    </a>`
  );
};

const createSiteMenuTemplate = (filters, currentFilterType, currentMenuItem) => {
  const currentActiveItem = (currentMenuItem === _utils_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].FILTER) ? currentFilterType : currentMenuItem;
  ...
  return (
    `<nav class="main-navigation">
      ...
      <a href="#stats" data-menu-item="${_utils_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATISTICS}" class="main-navigation__additional ${currentActiveItem === _utils_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATISTICS ? `main-navigation__item--active` : ``}">Stats</a>
    </nav>`
  );
};
...
/* harmony import */ var _smart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./smart.js */ "./src/templates/smart.js");
/* harmony import */ var _utils_date__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/date */ "./src/utils/date.js");
...
const getCommentTemplate = (commentItem) => {
  ...
  const formattedDate = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["getHumanizeCommentDate"])(date);
  ...
  return (
    `<li class="film-details__comment">
      ...
      <div>
        <p class="film-details__comment-text"><p class="film-details__comment-text">${he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(comment)}</p>
...
const createPopUpTemplate = (film) => {
  ...
  const releaseDate = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["getFormattedReleaseDate"])(release.date);
  const formattedRuntime = Object(_utils_date__WEBPACK_IMPORTED_MODULE_1__["getFormattedRuntime"])(filmDuration);
          ...
          <section class="film-details__comments-wrap">
            ...
            <div class="film-details__new-comment">
              ...
              <label class="film-details__comment-label">
                <textarea class="film-details__comment-input" placeholder="Select reaction below and write comment here" name="comment">${userText ? he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(userText) : ``}</textarea>
              </label>
...
class FilmPopUp extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _addCommentKeyDownHandler(evt) {
    if (evt.ctrlKey && evt.key === `Enter` && this._data.userText !== null && this._data.userText.length > 0 && this._data.userEmoji !== null) {
      ...
      const newComment = {
        "comment": he__WEBPACK_IMPORTED_MODULE_3___default.a.encode(this._data.userText),
...
.catch(() => {
  ...
  _createComment() {
    return {
      ...
      date: new Date(),
      author: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_2__["getRandomElement"])(AUTHORS),
...
const createSortTemplate = (currentSortType) => {
  ...
  <li><a href="#" class="sort__button ${currentSortType === _utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT ? `sort__button--active` : ``}" data-sort-type="${_utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">Sort by default</a></li>
  <li><a href="#" class="sort__button ${currentSortType === _utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE ? `sort__button--active` : ``}" data-sort-type="${_utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}">Sort by date</a></li>
  <li><a href="#" class="sort__button ${currentSortType === _utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING ? `sort__button--active` : ``}" data-sort-type="${_utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING}">Sort by rating</a></li>
    </ul>
    </div>
  `);
};
...
/* harmony import */ var _utils_user_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/user.js */ "./src/utils/user.js");
...
const getTopGenre = (films) => {
  const genres = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["getGenresFrequencies"])(films);
...
const createStatisticsTemplate = (films) => {
  ...
  const userRank = Object(_utils_user_js__WEBPACK_IMPORTED_MODULE_5__["getUserRank"])(films.length);
  ...
  return (`<section class="statistic">
      ...
      <form action="https://echo.htmlacademy.ru/" method="get" class="statistic__filters">
        ...
        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-all-time" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_4__["PeriodFilter"].ALL_TIME}" checked>
        <label for="statistic-all-time" class="statistic__filters-label">All time</label>
        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-today" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_4__["PeriodFilter"].TODAY}">
        <label for="statistic-today" class="statistic__filters-label">Today</label>
        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-week" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_4__["PeriodFilter"].WEEK}">
        <label for="statistic-week" class="statistic__filters-label">Week</label>
        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-month" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_4__["PeriodFilter"].MONTH}">
        <label for="statistic-month" class="statistic__filters-label">Month</label>
        <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-year" value="${_utils_const_js__WEBPACK_IMPORTED_MODULE_4__["PeriodFilter"].YEAR}">
...
const renderStatisticsChart = (statisticsCtx, films) => {
  const BAR_HEIGHT = 50;
  statisticsCtx.height = BAR_HEIGHT * Object.keys(Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["getGenresFrequencies"])(films)).length;
  return new chart_js__WEBPACK_IMPORTED_MODULE_2___default.a(statisticsCtx, {
    plugins: [chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_3___default.a],
    type: `horizontalBar`,
    data: {
      labels: Object.keys(Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["getGenresFrequencies"])(films)),
      datasets: [{
        data: Object.values(Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["getGenresFrequencies"])(films)),
...
class Statistics extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(films) {
    ...
    this._currentPeriod = _utils_const_js__WEBPACK_IMPORTED_MODULE_4__["PeriodFilter"].ALL_TIME;
  ...
  _setChart(period) {
    ...
    const filteredFilms = Object(_utils_statistics_js__WEBPACK_IMPORTED_MODULE_1__["filterFilmsByPeriod"])(period, this._films);
...
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/templates/abstract.js");
/* harmony import */ var _utils_user_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/user.js */ "./src/utils/user.js");


const createUserRankTemplate = (filmsModel) => {
  const watchedFilmsCount = [...filmsModel.getFilms()].filter((film) => film.isWatched).length;
  const userRank = Object(_utils_user_js__WEBPACK_IMPORTED_MODULE_1__["getUserRank"])(watchedFilmsCount);
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomFloatInteger, getRandomElement */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: UserAction, UpdateType, FilterType, MenuItem, PeriodFilter, RANKS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "PeriodFilter", function() { return PeriodFilter; });
...
/*!***************************!*\
  !*** ./src/utils/date.js ***!
  \***************************/
/*! exports provided: getFormattedReleaseDate, getFormattedRuntime, getHumanizeCommentDate, getCurrentDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFormattedReleaseDate", function() { return getFormattedReleaseDate; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getFormattedRuntime", function() { return getFormattedRuntime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHumanizeCommentDate", function() { return getHumanizeCommentDate; });
...
const getHumanizeCommentDate = (date) => {
  if (!(date instanceof Date)) {
    return ``;
  }
...
const filter = {
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL]: (movies) => movies,
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (movies) => movies.filter((movie) => movie.isInWatchlist),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (movies) => movies.filter((movie) => movie.isWatched),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (movies) => movies.filter((movie) => movie.isFavorite),
};
...
/*!***************************!*\
  !*** ./src/utils/sort.js ***!
  \***************************/
/*! exports provided: sortByDate, sortByRating, sortByComments, SortType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!*********************************!*\
  !*** ./src/utils/statistics.js ***!
  \*********************************/
/*! exports provided: getGenresFrequencies, filterFilmsByPeriod */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "filterFilmsByPeriod", function() { return filterFilmsByPeriod; });
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _utils_const_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/const.js */ "./src/utils/const.js");
...
const filterFilmsByPeriod = (period, films) => {
  switch (period) {
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PeriodFilter"].TODAY:
      return [...films].filter((film) => isWatchedToday(film.watchingDate));
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PeriodFilter"].WEEK:
      return [...films].filter((film) => isWatchedLastWeek(film.watchingDate));
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PeriodFilter"].MONTH:
      return [...films].filter((film) => isWatchedLastMonth(film.watchingDate));
    case _utils_const_js__WEBPACK_IMPORTED_MODULE_1__["PeriodFilter"].YEAR:
...
const isWatchedLastWeek = (date) => {
  ...
  const lastWeek = moment__WEBPACK_IMPORTED_MODULE_0___default()(today).subtract(1, `w`);

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(lastWeek, today);
};

const isWatchedLastMonth = (date) => {
  const today = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());
  const lastMonth = moment__WEBPACK_IMPORTED_MODULE_0___default()(today).subtract(1, `M`);

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(lastMonth, today);
};

const isWatchedLastYear = (date) => {
  const today = moment__WEBPACK_IMPORTED_MODULE_0___default()(new Date());
  const lastYear = moment__WEBPACK_IMPORTED_MODULE_0___default()(today).subtract(1, `y`);

  return moment__WEBPACK_IMPORTED_MODULE_0___default()(date).isBetween(lastYear, today);
};
