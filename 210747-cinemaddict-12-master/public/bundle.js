...
/* harmony import */ var _model_movie_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./model/movie.js */ "./src/model/movie.js");
/* harmony import */ var _templates_status_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./templates/status.js */ "./src/templates/status.js");
...
/* harmony import */ var _mocks_generate_film_card_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mocks/generate-film-card.js */ "./src/mocks/generate-film-card.js");
/* harmony import */ var _mocks_filters_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mocks/filters.js */ "./src/mocks/filters.js");
...
const films = new Array(FILMS_COUNT).fill().map(_mocks_generate_film_card_js__WEBPACK_IMPORTED_MODULE_5__["generateFilmCard"]);
const filters = Object(_mocks_filters_js__WEBPACK_IMPORTED_MODULE_6__["getFilters"])(films);
const siteHeaderElement = document.querySelector(`.header`);
const siteMainElement = document.querySelector(`.main`);
const filmsModel = new _model_movie_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
filmsModel.setFilms(films);

const movieList = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_4__["default"](filmsModel);
movieList.init();
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_0__["renderElement"])(siteHeaderElement, new _templates_status_js__WEBPACK_IMPORTED_MODULE_3__["default"](filters).getElement(), _utils_render_js__WEBPACK_IMPORTED_MODULE_0__["RenderPosition"].BEFOREEND);
...
const generateFilmDuration = () => {
  ...
  return Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomInteger"])(MIN_FILM_DURATION, MAX_FILM_DURATION);
};
...
const generateFilmCard = () => {
  return {
    ...
    watchingDate: Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["generateDate"])(),
  };
};
...
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _utils_sort__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/sort */ "./src/utils/sort.js");
...
class MovieList {
  constructor(filmsModel) {
    ...
    this._currentSortType = _utils_sort__WEBPACK_IMPORTED_MODULE_4__["SortType"].DEFAULT;
  ...
  _getFilms() {
    switch (this._currentSortType) {
      case _utils_sort__WEBPACK_IMPORTED_MODULE_4__["SortType"].DATE:
        return this._filmsModel.getFilms().slice().sort(_utils_sort__WEBPACK_IMPORTED_MODULE_4__["sortByDate"]);
      case _utils_sort__WEBPACK_IMPORTED_MODULE_4__["SortType"].RATING:
        return this._filmsModel.getFilms().slice().sort(_utils_sort__WEBPACK_IMPORTED_MODULE_4__["sortByRating"]);
      default:
  ...
  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["UserAction"].UPDATE_MOVIE:
        this._filmsModel.updateFilm(updateType, update);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["UserAction"].ADD_COMMENT:
        this._filmsModel.addComment(updateType, update);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["UserAction"].DELETE_COMMENT:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].PATCH:
        this._filmPresenter[data.id].init(data);
        break;
      case _utils_const_js__WEBPACK_IMPORTED_MODULE_5__["UpdateType"].MAJOR:
  ...
  _renderFilmCard(container, film) {
    ...
    const Movie = new _film_js__WEBPACK_IMPORTED_MODULE_1__["default"](container, this._handleViewAction, this._handleModeChange);
    Movie.init(film);
...
const createFiltersTemplate = () => {
  ...
  <li><a href="#" class="sort__button sort__button--active" data-sort-type="${_utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DEFAULT}">Sort by default</a></li>
  <li><a href="#" class="sort__button" data-sort-type="${_utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].DATE}">Sort by date</a></li>
  <li><a href="#" class="sort__button" data-sort-type="${_utils_sort__WEBPACK_IMPORTED_MODULE_1__["SortType"].RATING}">Sort by rating</a></li>
    </ul>
    </div>
  `);
};
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: getRandomInteger, getRandomFloatInteger, generateDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: UserAction, UpdateType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***************************!*\
  !*** ./src/utils/date.js ***!
  \***************************/
/*! exports provided: getFormattedReleaseDate, getFormattedRuntime, getHumanizeCommentDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
